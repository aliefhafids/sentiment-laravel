...
class ClassificationTestController extends Controller
{
    public function reviewsAndClassify()
    {
        try {
            ...
            $command = 'python ' . base_path('app/Scripts/class_data_test.py') . ' ' . escapeshellarg($tmpFile);
